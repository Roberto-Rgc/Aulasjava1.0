...
git config --global user.name "Roberto-Rgc"
git config --global user.email "robetodegoescorreia@gmail.com"

:: Adiciona o repositório remoto (só executa se já não estiver adicionado)
git remote get-url origin >nul 2>&1
if errorlevel 1 (
    git remote add origin "https://github.com/Roberto-Rgc/Aulasjava1.0.git"
)
